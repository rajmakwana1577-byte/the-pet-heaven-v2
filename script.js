/* ==========================================================
   THE PET HEAVEN
   Premium Mobile JavaScript v3.0
   Part 1
========================================================== */
...
const owner =
bookingForm.querySelector('input[placeholder="Owner Name"]').value.trim();

const pet =
bookingForm.querySelector('input[placeholder="Pet Name"]').value.trim();

const mobile =
bookingForm.querySelector('input[placeholder="Mobile Number"]').value.trim();
...
const time =
bookingForm.querySelector('input[type="time"]').value;
...
console.log("☀️ Light Mode Preferred");
...
sessionStorage.getItem("petHeavenVisit")
...
/* ==========================================================
   Small Vibration (Supported Phones)
========================================================== */
